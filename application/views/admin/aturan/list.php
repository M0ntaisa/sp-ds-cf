                                        ...
                                        <table class="table hover-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="600px" rowspan="2" style="text-align:center;padding:25px;">Gejala</th>
                                                    <th rowspan="2" style="text-align:center;padding:25px;">Penyakit</th>
                                                    <th width="140px">Nilai Aturan DS</th>
                                                    <th colspan="2">Nilai Aturan CF</th>
                                                    <th rowspan="2" style="text-align:center;padding:25px;" width="160px">Opsi</th>
                                                </tr>
                                                <tr>
                                                    <th>Belief</th>
                                                    <th>MB</th>
                                            ...
                                            <tbody>
                                                <?php $x = 1; foreach($aturan as $row) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="nilai_ds" max="1" min="0" step="0.01" value="<?= $row['cf']; ?>">
                                                        </td>
                                                        <td>
